...
class SalaryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'bpjs_jht_karyawan' => ['integer'],
            'bpjs_kesehatan_karyawan' => ['integer'],
            'bpjs_jp_karyawan' => ['integer'],
            'asuransi_lainnya_karyawan' => ['integer'],
            'bpjs_jht_kantor' => ['integer'],
            'bpjs_kesehatan_kantor' => ['integer'],
            'bpjs_jp_kantor' => ['integer'],
            'asuransi_lainnya_kantor' => ['integer'],
            'bpjs_jkm_kantor' => ['integer'],
            'bpjs_jkk_kantor' => ['integer'],
        ]);
